...
const sharp_1 = __importDefault(require("sharp")); // load sharp
/**
 ...
 */
const resizeImage = (params) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return 'this image cannot be resized.';
    }
});
